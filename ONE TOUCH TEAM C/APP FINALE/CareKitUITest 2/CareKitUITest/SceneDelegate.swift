    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let symptomTrackerVC = SymptomTrackerViewController(storeManager: CareStoreReferenceManager.shared.synchronizedStoreManager)
                ...
                if let windowScene = scene as? UIWindowScene {
                    ...
                    window?.tintColor = UIColor { $0.userInterfaceStyle == .light ? #colorLiteral(red: 0.2588235438, green: 0.7568627596, blue: 0.9686274529, alpha: 1) : #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1) }
